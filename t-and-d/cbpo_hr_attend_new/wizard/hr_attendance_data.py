...
class hr_attendance_data(osv.osv_memory):

    _name = 'hr.attendance.data'
    _description = 'Print data Attendance Report'
    _columns = {
    ...
    def print_report(self, cr, uid, ids, context=None):
        emp_ids = []
        data_data = self.read(cr, uid, ids, context=context)[0]
        date_from = data_data['init_date']
        date_to = data_data['end_date']
        ...
        return self.pool['report'].get_action(
            cr, uid, [], 'hr_attendance.report_attendancedatas', data=datas, context=context
        )
